                ...
                if (do_evict) {
                    ...
                    if ((search->it_flags & ITEM_FETCHED) == 0) {
                        if (settings.verbose > 1)
                            fprintf(stderr, "set evicted num  the flag is : %llu, ITEM_FETCHED is: %llu, & result is : %u\n",
                            (unsigned long long)search->it_flags, (unsigned long long)ITEM_FETCHED,
                            (unsigned int)(search->it_flags & ITEM_FETCHED));
